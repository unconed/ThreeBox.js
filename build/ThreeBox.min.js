...
(function(){function c(a,e,g){if(a===e)return 0!==a||1/a==1/e;if(null==a||null==e)return a===e;a._chain&&(a=a._wrapped);e._chain&&(e=e._wrapped);if(a.isEqual&&b.isFunction(a.isEqual))return a.isEqual(e);if(e.isEqual&&b.isFunction(e.isEqual))return e.isEqual(a);var h=n.call(a);if(h!=n.call(e))return!1;switch(h){case "[object String]":return a==""+e;case "[object Number]":return a!=+a?e!=+e:0==a?1/a==1/e:a==+e;case "[object Date]":case "[object Boolean]":return+a==+e;case "[object RegExp]":return a.source==
e.source&&a.global==e.global&&a.multiline==e.multiline&&a.ignoreCase==e.ignoreCase}if("object"!=typeof a||"object"!=typeof e)return!1;for(var d=g.length;d--;)if(g[d]==a)return!0;g.push(a);var d=0,q=!0;if("[object Array]"==h){if(d=a.length,q=d==e.length)for(;d--&&(q=d in a==d in e&&c(a[d],e[d],g)););}else{if("constructor"in a!="constructor"in e||a.constructor!=e.constructor)return!1;for(var f in a)if(b.has(a,f)&&(d++,!(q=b.has(e,f)&&c(a[f],e[f],g))))break;if(q){for(f in e)if(b.has(e,f)&&!d--)break;
q=!d}}g.pop();return q}var d=this,f=d._,i={},j=Array.prototype,m=Object.prototype,k=j.slice,s=j.unshift,n=m.toString,J=m.hasOwnProperty,z=j.forEach,A=j.map,B=j.reduce,C=j.reduceRight,D=j.filter,E=j.every,F=j.some,t=j.indexOf,G=j.lastIndexOf,m=Array.isArray,K=Object.keys,u=Function.prototype.bind,b=function(a){return new p(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=b),exports._=b):d._=b;b.VERSION="1.3.3";var l=b.each=b.forEach=function(a,
...
b.bind(a[c],a)});return a};b.memoize=function(a,c){var d={};c||(c=b.identity);return function(){var f=c.apply(this,arguments);return b.has(d,f)?d[f]:d[f]=a.apply(this,arguments)}};b.delay=function(a,b){var c=k.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};b.defer=function(a){return b.delay.apply(b,[a,1].concat(k.call(arguments,1)))};b.throttle=function(a,c){var d,f,j,k,i,m,l=b.debounce(function(){i=k=!1},c);return function(){d=this;f=arguments;j||(j=setTimeout(function(){j=
null;i&&a.apply(d,f);l()},c));k?i=!0:m=a.apply(d,f);l();k=!0;return m}};b.debounce=function(a,b,c){var d;return function(){var f=this,j=arguments;c&&!d&&a.apply(f,j);clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(f,j)},b)}};b.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};b.wrap=function(a,b){return function(){var c=[a].concat(k.call(arguments,0));return b.apply(this,c)}};b.compose=function(){var a=arguments;return function(){for(var b=
...
c))return!1;return!0};b.isElement=function(a){return!!(a&&1==a.nodeType)};b.isArray=m||function(a){return"[object Array]"==n.call(a)};b.isObject=function(a){return a===Object(a)};b.isArguments=function(a){return"[object Arguments]"==n.call(a)};b.isArguments(arguments)||(b.isArguments=function(a){return!(!a||!b.has(a,"callee"))});b.isFunction=function(a){return"[object Function]"==n.call(a)};b.isString=function(a){return"[object String]"==n.call(a)};b.isNumber=function(a){return"[object Number]"==
...
function(a,b,c){for(var d=0;d<a;d++)b.call(c,d)};b.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};b.result=function(a,c){if(null==a)return null;var d=a[c];return b.isFunction(d)?d.call(a):d};b.mixin=function(a){l(b.functions(a),function(c){var d=b[c]=a[c];p.prototype[c]=function(){var a=k.call(arguments);s.call(a,this._wrapped);return v(d.apply(b,a),this._chain)}})};var L=0;b.uniqueId=
...
b.chain=function(a){return b(a).chain()};var p=function(a){this._wrapped=a};b.prototype=p.prototype;var v=function(a,c){return c?b(a).chain():a};b.mixin(b);l("pop push reverse shift sort splice unshift".split(" "),function(a){var b=j[a];p.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var d=c.length;("shift"==a||"splice"==a)&&0===d&&delete c[0];return v(c,this._chain)}});l(["concat","join","slice"],function(a){var b=j[a];p.prototype[a]=function(){return v(b.apply(this._wrapped,arguments),
this._chain)}});p.prototype.chain=function(){this._chain=!0;return this};p.prototype.value=function(){return this._wrapped}}).call(this);var \u03c0=Math.PI,\u03c4=2*\u03c0;(function(c){for(var d in c)if(!window[d])throw"Error: ThreeBox requires "+c[d];})({THREE:"Three.js",tQuery:"tQuery.js (bundle)"});window.ThreeBox={};window.threeBox=function(c,d){c&&!(c instanceof Node)&&(d=c,c=null);return tQuery.createWorld(d).threeBox(c,d)};
...
this._mouseUp=function(){this.drag=!1}.bind(this);this._mouseMove=function(d){if(c.drag){var f={x:d.pageX-c.origin.x,y:d.pageY-c.origin.y},i={x:d.pageX-c.lastHover.x,y:d.pageY-c.lastHover.y};c.lastHover={x:d.pageX,y:d.pageY};c.moved(c.origin,f,i)}}.bind(this);this.element&&(this.element.addEventListener("mousedown",this._mouseDown,!1),document.addEventListener("mouseup",this._mouseUp,!1),document.addEventListener("mousemove",this._mouseMove,!1))},stop:function(){this.element&&(this.element.removeEventListener("mousedown",
this._mouseDown),document.removeEventListener("mouseup",this._mouseUp),document.removeEventListener("mousemove",this._mouseMove))},moved:function(c,d,f){this.phi+=f.x*this.speed/this.width;this.theta=Math.min(\u03c0/2,Math.max(-\u03c0/2,this.theta+f.y*this.speed/this.height));this.emit("change")},update:function(){this.camera.position.x=Math.cos(this.phi)*Math.cos(this.theta)*this.orbit;this.camera.position.y=Math.sin(this.theta)*this.orbit;this.camera.position.z=Math.sin(this.phi)*Math.cos(this.theta)*
this.orbit;this.camera.position.addSelf(this.lookAt);this.camera.lookAt(this.lookAt)}};ThreeBox.OrbitControls.bind=function(c,d,f){return new ThreeBox.OrbitControls(c,d,f)};MicroEvent.mixin(ThreeBox.OrbitControls);
ThreeBox.Cursor=function(c,d){function f(){m||(c.style.cursor=i);clearTimeout(j);m=!1;j=setTimeout(function(){m=!0;c.style.cursor="none"},k)}var i=d.cameraControls?"move":"default",j=null,m=!1,k=2E3;d.cursor?c.style.cursor=i:(c.addEventListener("mousemove",f),c.style.cursor="none");return{unbind:function(){c.removeEventListener("mousemove",f)}}};ThreeBox.Cursor.bind=function(c,d){return ThreeBox.Cursor(c,d)};
