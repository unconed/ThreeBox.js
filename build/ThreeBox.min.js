...
d=!m}}g.pop();return d}var d=this,f=d._,k={},i=Array.prototype,n=Object.prototype,j=i.slice,s=i.unshift,p=n.toString,J=n.hasOwnProperty,z=i.forEach,A=i.map,B=i.reduce,C=i.reduceRight,D=i.filter,E=i.every,F=i.some,t=i.indexOf,G=i.lastIndexOf,n=Array.isArray,K=Object.keys,u=Function.prototype.bind,b=function(a){return new q(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=b),exports._=b):d._=b;b.VERSION="1.3.3";var l=b.each=b.forEach=function(a,
e,g){if(null!=a)if(z&&a.forEach===z)a.forEach(e,g);else if(a.length===+a.length)for(var h=0,c=a.length;h<c&&!(h in a&&e.call(g,a[h],h,a)===k);h++);else for(h in a)if(b.has(a,h)&&e.call(g,a[h],h,a)===k)break};b.map=b.collect=function(a,e,b){var h=[];if(null==a)return h;if(A&&a.map===A)return a.map(e,b);l(a,function(a,c,d){h[h.length]=e.call(b,a,c,d)});a.length===+a.length&&(h.length=a.length);return h};b.reduce=b.foldl=b.inject=function(a,e,g,h){var c=2<arguments.length;null==a&&(a=[]);if(B&&a.reduce===
...
function(a,e,g){g||(g=b.identity);for(var c=0,d=a.length;c<d;){var f=c+d>>1;g(a[f])<g(e)?c=f+1:d=f}return c};b.toArray=function(a){return!a?[]:b.isArray(a)||b.isArguments(a)?j.call(a):a.toArray&&b.isFunction(a.toArray)?a.toArray():b.values(a)};b.size=function(a){return b.isArray(a)?a.length:b.keys(a).length};b.first=b.head=b.take=function(a,b,g){return null!=b&&!g?j.call(a,0,b):a[0]};b.initial=function(a,b,g){return j.call(a,0,a.length-(null==b||g?1:b))};b.last=function(a,b,g){return null!=b&&!g?
j.call(a,Math.max(a.length-b,0)):a[a.length-1]};b.rest=b.tail=function(a,b,g){return j.call(a,null==b||g?1:b)};b.compact=function(a){return b.filter(a,function(a){return!!a})};b.flatten=function(a,e){return b.reduce(a,function(a,c){if(b.isArray(c))return a.concat(e?c:b.flatten(c));a[a.length]=c;return a},[])};b.without=function(a){return b.difference(a,j.call(arguments,1))};b.uniq=b.unique=function(a,e,c){var c=c?b.map(a,c):a,d=[];3>a.length&&(e=!0);b.reduce(c,function(c,g,f){if(e?b.last(c)!==g||
!c.length:!b.include(c,g))c.push(g),d.push(a[f]);return c},[]);return d};b.union=function(){return b.uniq(b.flatten(arguments,!0))};b.intersection=b.intersect=function(a){var e=j.call(arguments,1);return b.filter(b.uniq(a),function(a){return b.every(e,function(e){return 0<=b.indexOf(e,a)})})};b.difference=function(a){var e=b.flatten(j.call(arguments,1),!0);return b.filter(a,function(a){return!b.include(e,a)})};b.zip=function(){for(var a=j.call(arguments),e=b.max(b.pluck(a,"length")),c=Array(e),d=
...
a)/c),0),f=0,i=Array(d);f<d;)i[f++]=a,a+=c;return i};var I=function(){};b.bind=function(a,e){var c,d;if(a.bind===u&&u)return u.apply(a,j.call(arguments,1));if(!b.isFunction(a))throw new TypeError;d=j.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(e,d.concat(j.call(arguments)));I.prototype=a.prototype;var b=new I,f=a.apply(b,d.concat(j.call(arguments)));return Object(f)===f?f:b}};b.bindAll=function(a){var c=j.call(arguments,1);0==c.length&&(c=b.functions(a));l(c,function(c){a[c]=
b.bind(a[c],a)});return a};b.memoize=function(a,c){var d={};c||(c=b.identity);return function(){var f=c.apply(this,arguments);return b.has(d,f)?d[f]:d[f]=a.apply(this,arguments)}};b.delay=function(a,b){var c=j.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};b.defer=function(a){return b.delay.apply(b,[a,1].concat(j.call(arguments,1)))};b.throttle=function(a,c){var d,f,i,j,k,n,l=b.debounce(function(){k=j=!1},c);return function(){d=this;f=arguments;i||(i=setTimeout(function(){i=
null;k&&a.apply(d,f);l()},c));j?k=!0:n=a.apply(d,f);l();j=!0;return n}};b.debounce=function(a,b,c){var d;return function(){var f=this,i=arguments;c&&!d&&a.apply(f,i);clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(f,i)},b)}};b.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};b.wrap=function(a,b){return function(){var c=[a].concat(j.call(arguments,0));return b.apply(this,c)}};b.compose=function(){var a=arguments;return function(){for(var b=
arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};b.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};b.keys=K||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var c=[],d;for(d in a)b.has(a,d)&&(c[c.length]=d);return c};b.values=function(a){return b.map(a,b.identity)};b.functions=b.methods=function(a){var c=[],d;for(d in a)b.isFunction(a[d])&&c.push(d);return c.sort()};b.extend=function(a){l(j.call(arguments,1),function(b){for(var c in b)a[c]=
b[c]});return a};b.pick=function(a){var c={};l(b.flatten(j.call(arguments,1)),function(b){b in a&&(c[b]=a[b])});return c};b.defaults=function(a){l(j.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};b.clone=function(a){return!b.isObject(a)?a:b.isArray(a)?a.slice():b.extend({},a)};b.tap=function(a,b){b(a);return a};b.isEqual=function(a,b){return c(a,b,[])};b.isEmpty=function(a){if(null==a)return!0;if(b.isArray(a)||b.isString(a))return 0===a.length;for(var c in a)if(b.has(a,
...
function(a,b,c){for(var d=0;d<a;d++)b.call(c,d)};b.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};b.result=function(a,c){if(null==a)return null;var d=a[c];return b.isFunction(d)?d.call(a):d};b.mixin=function(a){l(b.functions(a),function(c){var d=b[c]=a[c];q.prototype[c]=function(){var a=j.call(arguments);s.call(a,this._wrapped);return v(d.apply(b,a),this._chain)}})};var L=0;b.uniqueId=
...
b.chain=function(a){return b(a).chain()};var q=function(a){this._wrapped=a};b.prototype=q.prototype;var v=function(a,c){return c?b(a).chain():a};b.mixin(b);l("pop push reverse shift sort splice unshift".split(" "),function(a){var b=i[a];q.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var d=c.length;("shift"==a||"splice"==a)&&0===d&&delete c[0];return v(c,this._chain)}});l(["concat","join","slice"],function(a){var b=i[a];q.prototype[a]=function(){return v(b.apply(this._wrapped,arguments),
...
tQuery.World.register("addThreeBox",function(c,d){console.assert(!0!==this.hasThreeBox());d=tQuery.extend(d,{cameraControls:!1,cursor:!0,controlClass:ThreeBox.OrbitControls,elementResize:!0,fullscreen:!0,screenshot:!0,stats:!0,scale:1});this.tRenderer().domElement.style.display="block";var f={};tQuery.data(this,"_threeBoxContext",f);var k=this.tCamera(),i=this.tRenderer();d.stats&&(f.stats=new Stats,f.stats.domElement.style.position="absolute",f.stats.domElement.style.left="10px",f.stats.domElement.style.top=
"10px",c&&c.appendChild(f.stats.domElement),f.loopStats=function(){f.stats.update()},this.loop().hook(f.loopStats));if(d.cameraControls){var n=this.loop(),j=this.render.bind(this);f.cameraControls=ThreeBox.OrbitControls.bind(k,c,d).on("change",function(){n._timerId||j()});this.setCameraControls(f.cameraControls)}d.elementResize&&(f.elementResize=ThreeBox.ElementResize.bind(i,k,c,d.scale).on("resize",function(c,d){this._opts.renderW=c;this._opts.renderH=d;this.emit("resize",c,d)}.bind(this)));null!==
d.cursor&&(f.cursor=ThreeBox.Cursor.bind(c,d));d.screenshot&&(f.screenshot=THREEx.Screenshot.bindKey(i));d.fullscreen&&THREEx.FullScreen.available()&&(f.fullscreen=THREEx.FullScreen.bindKey());f._$onDestroy=this.bind("destroy",function(){!1!==this.hasThreeBox()&&this.removeThreeBox()});return this});tQuery.World.register("hasThreeBox",function(){return void 0===tQuery.data(this,"_threeBoxContext")?!1:!0});
...
ThreeBox.ElementResize=function(c,d,f,k){this.scale=k||1;k=this.callback=function(){var i=Math.floor(f.offsetWidth),k=Math.floor(f.offsetHeight);c.domElement.style.position="absolute";c.domElement.style.width=i+"px";c.domElement.style.height=k+"px";var j=Math.floor(i/this.scale),s=Math.floor(k/this.scale);c.setSize(j,s);d.aspect=i/k;d.updateProjectionMatrix();this.emit("resize",j,s)}.bind(this);window.addEventListener("resize",k,!1);f.addEventListener("resize",k,!1);setTimeout(k,0)};
ThreeBox.ElementResize.bind=function(c,d,f,k){return new ThreeBox.ElementResize(c,d,f,k)};ThreeBox.ElementResize.prototype.scale=function(c){this.scale=c};ThreeBox.ElementResize.prototype.unbind=function(){window.removeEventListener("resize",callback);domElement.removeEventListener("resize",callback)};MicroEvent.mixin(ThreeBox.ElementResize);
...
ThreeBox.Cursor=function(c,d){function f(){n||(c.style.cursor=k);clearTimeout(i);n=!1;i=setTimeout(function(){n=!0;c.style.cursor="none"},j)}var k=d.cameraControls?"move":"default",i=null,n=!1,j=2E3;d.cursor?c.style.cursor=k:(c.addEventListener("mousemove",f),c.style.cursor="none");return{unbind:function(){c.removeEventListener("mousemove",f)}}};ThreeBox.Cursor.bind=function(c,d){return ThreeBox.Cursor(c,d)};
ThreeBox.preload=function(c,d){c instanceof Function&&(d=c,c=[]);var c="string"==typeof c?[c]:c,f=c.length;_.each(c,function(c){new microAjax(c,function(c){var k;(k=c.match(/^<script[^>]*type=['"]text\/javascript['"][^>]*>([\s\S]+?)<\/script>$/m))?(c=document.createElement("script"),c.type="text/javascript",c.innerHTML=k[1],document.body.appendChild(c)):(k=document.createElement("div"),k.innerHTML=c,document.body.appendChild(k));0==--f&&d()})})};
