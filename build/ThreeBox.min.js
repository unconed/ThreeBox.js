...
s=!d}}l.pop();return s}var d=this,e=d._,h={},g=Array.prototype,m=Object.prototype,k=g.slice,q=g.unshift,p=m.toString,L=m.hasOwnProperty,B=g.forEach,C=g.map,D=g.reduce,E=g.reduceRight,F=g.filter,G=g.every,H=g.some,u=g.indexOf,I=g.lastIndexOf,m=Array.isArray,M=Object.keys,w=Function.prototype.bind,c=function(a){return new r(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=c),exports._=c):d._=c;c.VERSION="1.3.3";var n=c.each=c.forEach=function(a,
f,l){if(null!=a)if(B&&a.forEach===B)a.forEach(f,l);else if(a.length===+a.length)for(var b=0,d=a.length;b<d&&!(b in a&&f.call(l,a[b],b,a)===h);b++);else for(b in a)if(c.has(a,b)&&f.call(l,a[b],b,a)===h)break};c.map=c.collect=function(a,f,c){var b=[];if(null==a)return b;if(C&&a.map===C)return a.map(f,c);n(a,function(a,d,e){b[b.length]=f.call(c,a,d,e)});a.length===+a.length&&(b.length=a.length);return b};c.reduce=c.foldl=c.inject=function(a,f,l,b){var d=2<arguments.length;null==a&&(a=[]);if(D&&a.reduce===
...
var A=function(a,b){return b?c(a).chain():a},N=function(a,b){r.prototype[a]=function(){var a=k.call(arguments);q.call(a,this._wrapped);return A(b.apply(c,a),this._chain)}};c.mixin(c);n("pop push reverse shift sort splice unshift".split(" "),function(a){var b=g[a];r.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var d=c.length;"shift"!=a&&"splice"!=a||0!==d||delete c[0];return A(c,this._chain)}});n(["concat","join","slice"],function(a){var b=g[a];r.prototype[a]=function(){return A(b.apply(this._wrapped,
