...
(function(){function b(a,f,l){if(a===f)return 0!==a||1/a==1/f;if(null==a||null==f)return a===f;a._chain&&(a=a._wrapped);f._chain&&(f=f._wrapped);if(a.isEqual&&c.isFunction(a.isEqual))return a.isEqual(f);if(f.isEqual&&c.isFunction(f.isEqual))return f.isEqual(a);var v=p.call(a);if(v!=p.call(f))return!1;switch(v){case "[object String]":return a==""+f;case "[object Number]":return a!=+a?f!=+f:0==a?1/a==1/f:a==+f;case "[object Date]":case "[object Boolean]":return+a==+f;case "[object RegExp]":return a.source==
f.source&&a.global==f.global&&a.multiline==f.multiline&&a.ignoreCase==f.ignoreCase}if("object"!=typeof a||"object"!=typeof f)return!1;for(var d=l.length;d--;)if(l[d]==a)return!0;l.push(a);var d=0,s=!0;if("[object Array]"==v){if(d=a.length,s=d==f.length)for(;d--&&(s=d in a==d in f&&b(a[d],f[d],l)););}else{if("constructor"in a!="constructor"in f||a.constructor!=f.constructor)return!1;for(var e in a)if(c.has(a,e)&&(d++,!(s=c.has(f,e)&&b(a[e],f[e],l))))break;if(s){for(e in f)if(c.has(f,e)&&!d--)break;
s=!d}}l.pop();return s}var d=this,e=d._,g={},h=Array.prototype,m=Object.prototype,k=h.slice,q=h.unshift,p=m.toString,L=m.hasOwnProperty,B=h.forEach,C=h.map,D=h.reduce,E=h.reduceRight,F=h.filter,G=h.every,H=h.some,u=h.indexOf,I=h.lastIndexOf,m=Array.isArray,M=Object.keys,w=Function.prototype.bind,c=function(a){return new r(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=c),exports._=c):d._=c;c.VERSION="1.3.3";var n=c.each=c.forEach=function(a,
f,l){if(null!=a)if(B&&a.forEach===B)a.forEach(f,l);else if(a.length===+a.length)for(var b=0,d=a.length;b<d&&!(b in a&&f.call(l,a[b],b,a)===g);b++);else for(b in a)if(c.has(a,b)&&f.call(l,a[b],b,a)===g)break};c.map=c.collect=function(a,f,c){var b=[];if(null==a)return b;if(C&&a.map===C)return a.map(f,c);n(a,function(a,d,e){b[b.length]=f.call(c,a,d,e)});a.length===+a.length&&(b.length=a.length);return b};c.reduce=c.foldl=c.inject=function(a,f,l,b){var d=2<arguments.length;null==a&&(a=[]);if(D&&a.reduce===
D)return b&&(f=c.bind(f,b)),d?a.reduce(f,l):a.reduce(f);n(a,function(a,c,e){d?l=f.call(b,l,a,c,e):(l=a,d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");return l};c.reduceRight=c.foldr=function(a,f,l,b){var d=2<arguments.length;null==a&&(a=[]);if(E&&a.reduceRight===E)return b&&(f=c.bind(f,b)),d?a.reduceRight(f,l):a.reduceRight(f);var e=c.toArray(a).reverse();b&&!d&&(f=c.bind(f,b));return d?c.reduce(e,f,l,b):c.reduce(e,f)};c.find=c.detect=function(a,f,c){var b;J(a,function(a,
d,e){if(f.call(c,a,d,e))return b=a,!0});return b};c.filter=c.select=function(a,f,c){var b=[];if(null==a)return b;if(F&&a.filter===F)return a.filter(f,c);n(a,function(a,d,e){f.call(c,a,d,e)&&(b[b.length]=a)});return b};c.reject=function(a,f,c){var b=[];if(null==a)return b;n(a,function(a,d,e){f.call(c,a,d,e)||(b[b.length]=a)});return b};c.every=c.all=function(a,f,c){var b=!0;if(null==a)return b;if(G&&a.every===G)return a.every(f,c);n(a,function(a,d,e){if(!(b=b&&f.call(c,a,d,e)))return g});return!!b};
var J=c.some=c.any=function(a,f,b){f||(f=c.identity);var d=!1;if(null==a)return d;if(H&&a.some===H)return a.some(f,b);n(a,function(a,c,e){if(d||(d=f.call(b,a,c,e)))return g});return!!d};c.include=c.contains=function(a,f){var c=!1;return null==a?c:u&&a.indexOf===u?-1!=a.indexOf(f):c=J(a,function(a){return a===f})};c.invoke=function(a,f){var b=k.call(arguments,2);return c.map(a,function(a){return(c.isFunction(f)?f||a:a[f]).apply(a,b)})};c.pluck=function(a,f){return c.map(a,function(a){return a[f]})};
...
d=Array(b),e=0;e<b;e++)d[e]=c.pluck(a,""+e);return d};c.indexOf=function(a,b,d){if(null==a)return-1;var e;if(d)return d=c.sortedIndex(a,b),a[d]===b?d:-1;if(u&&a.indexOf===u)return a.indexOf(b);d=0;for(e=a.length;d<e;d++)if(d in a&&a[d]===b)return d;return-1};c.lastIndexOf=function(a,c){if(null==a)return-1;if(I&&a.lastIndexOf===I)return a.lastIndexOf(c);for(var b=a.length;b--;)if(b in a&&a[b]===c)return b;return-1};c.range=function(a,c,b){1>=arguments.length&&(c=a||0,a=0);b=arguments[2]||1;for(var d=
Math.max(Math.ceil((c-a)/b),0),e=0,g=Array(d);e<d;)g[e++]=a,a+=b;return g};var K=function(){};c.bind=function(a,b){var d,e;if(a.bind===w&&w)return w.apply(a,k.call(arguments,1));if(!c.isFunction(a))throw new TypeError;e=k.call(arguments,2);return d=function(){if(!(this instanceof d))return a.apply(b,e.concat(k.call(arguments)));K.prototype=a.prototype;var c=new K,g=a.apply(c,e.concat(k.call(arguments)));return Object(g)===g?g:c}};c.bindAll=function(a){var b=k.call(arguments,1);0==b.length&&(b=c.functions(a));
n(b,function(b){a[b]=c.bind(a[b],a)});return a};c.memoize=function(a,b){var d={};b||(b=c.identity);return function(){var e=b.apply(this,arguments);return c.has(d,e)?d[e]:d[e]=a.apply(this,arguments)}};c.delay=function(a,c){var b=k.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};c.defer=function(a){return c.delay.apply(c,[a,1].concat(k.call(arguments,1)))};c.throttle=function(a,b){var d,e,g,h,k,p,m=c.debounce(function(){k=h=!1},b);return function(){d=this;e=arguments;g||
(g=setTimeout(function(){g=null;k&&a.apply(d,e);m()},b));h?k=!0:p=a.apply(d,e);m();h=!0;return p}};c.debounce=function(a,b,c){var d;return function(){var e=this,g=arguments;c&&!d&&a.apply(e,g);clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(e,g)},b)}};c.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};c.wrap=function(a,b){return function(){var c=[a].concat(k.call(arguments,0));return b.apply(this,c)}};c.compose=function(){var a=arguments;
return function(){for(var b=arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};c.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};c.keys=M||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],d;for(d in a)c.has(a,d)&&(b[b.length]=d);return b};c.values=function(a){return c.map(a,c.identity)};c.functions=c.methods=function(a){var b=[],d;for(d in a)c.isFunction(a[d])&&b.push(d);return b.sort()};c.extend=function(a){n(k.call(arguments,
...
p.call(a)};c.isFinite=function(a){return c.isNumber(a)&&isFinite(a)};c.isNaN=function(a){return a!==a};c.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==p.call(a)};c.isDate=function(a){return"[object Date]"==p.call(a)};c.isRegExp=function(a){return"[object RegExp]"==p.call(a)};c.isNull=function(a){return null===a};c.isUndefined=function(a){return void 0===a};c.has=function(a,b){return L.call(a,b)};c.noConflict=function(){d._=e;return this};c.identity=function(a){return a};c.times=
function(a,b,c){for(var d=0;d<a;d++)b.call(c,d)};c.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};c.result=function(a,b){if(null==a)return null;var d=a[b];return c.isFunction(d)?d.call(a):d};c.mixin=function(a){n(c.functions(a),function(b){N(b,c[b]=a[b])})};var O=0;c.uniqueId=function(a){var b=O++;return a?a+b:b};c.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,
escape:/<%-([\s\S]+?)%>/g};var x=/.^/,t={"\\":"\\","'":"'",r:"\r",n:"\n",t:"\t",u2028:"\u2028",u2029:"\u2029"},y;for(y in t)t[t[y]]=y;var P=/\\|'|\r|\n|\t|\u2028|\u2029/g,Q=/\\(\\|'|r|n|t|u2028|u2029)/g,z=function(a){return a.replace(Q,function(a,b){return t[b]})};c.template=function(a,b,d){d=c.defaults(d||{},c.templateSettings);a="__p+='"+a.replace(P,function(a){return"\\"+t[a]}).replace(d.escape||x,function(a,b){return"'+\n_.escape("+z(b)+")+\n'"}).replace(d.interpolate||x,function(a,b){return"'+\n("+
...
var A=function(a,b){return b?c(a).chain():a},N=function(a,b){r.prototype[a]=function(){var a=k.call(arguments);q.call(a,this._wrapped);return A(b.apply(c,a),this._chain)}};c.mixin(c);n("pop push reverse shift sort splice unshift".split(" "),function(a){var b=h[a];r.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var d=c.length;"shift"!=a&&"splice"!=a||0!==d||delete c[0];return A(c,this._chain)}});n(["concat","join","slice"],function(a){var b=h[a];r.prototype[a]=function(){return A(b.apply(this._wrapped,
...
"10px",b&&b.appendChild(e.stats.domElement),e.loopStats=function(){e.stats.update()},this.loop().hook(e.loopStats));if(d.cameraControls){var m=this.loop(),k=this.render.bind(this);e.cameraControls=new d.controlClass(g,b,d);if(e.cameraControls.on)e.cameraControls.on("change",function(){m._timerId||k()});this.setCameraControls(e.cameraControls)}d.elementResize&&(e.elementResize=ThreeBox.ElementResize.bind(h,g,b,d).on("resize",function(b,d){this._opts.renderW=b;this._opts.renderH=d;this.emit("resize",
...
Math.sin(this.phi)*Math.cos(this.theta)*this.orbit;this.camera.position.add(this.lookAt);this.camera.lookAt(this.lookAt)}};ThreeBox.OrbitControls.bind=function(b,d,e){return new ThreeBox.OrbitControls(b,d,e)};MicroEvent.mixin(ThreeBox.OrbitControls);
ThreeBox.Cursor=function(b,d){function e(){m||(b.style.cursor=g);clearTimeout(h);m=!1;h=setTimeout(function(){m=!0;b.style.cursor="none"},k)}var g=d.cameraControls?"move":"default",h=null,m=!1,k=2E3;d.cursor?b.style.cursor=g:(b.addEventListener("mousemove",e),b.style.cursor="none");return{unbind:function(){b.removeEventListener("mousemove",e)}}};ThreeBox.Cursor.bind=function(b,d){return ThreeBox.Cursor(b,d)};
ThreeBox.preload=function(b,d){b instanceof Function&&(d=b,b=[]);b="string"==typeof b?[b]:b;var e=b.length,g={},h=function(b){_.extend(g,b||{});0==--e&&d(g)},m=ThreeBox.preload,k={},q={html:m.html,jpg:m.image,png:m.image,gif:m.image,mp3:m.audio};_.each(q,function(b,d){k[d]=RegExp("\\."+d+"$")});_.each(b,function(b){_.each(q,function(d,e){if(b.match(k[e])){var g=b.split(/\//g).pop().replace(/\.[A-Za-z0-9]+$/,"");d(b,g,h)}})})};
