...
ThreeBox.preload=function(a,b){a instanceof Function&&(b=a,a=[]);var a="string"==typeof a?[a]:a,c=a.length;_.each(a,function(a){new microAjax(a,function(a){var d=document.createElement("div");d.innerHTML=a;document.body.appendChild(d);0==--c&&b()})})};
