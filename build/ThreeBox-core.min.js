...
ThreeBox.preload=function(a,b){a instanceof Function&&(b=a,a=[]);var a="string"==typeof a?[a]:a,c=a.length;_.each(a,function(a){new microAjax(a,function(a){var d;if(d=a.match(/^<script[^>]*type=['"]text\/javascript['"][^>]*>(.+?)<\/script>$/))a=document.createElement("script"),a.type="text/javascript",a.innerHTML=d[1],document.body.appendChild(a),console.log("script",a);else{var f=document.createElement("div");f.innerHTML=a;document.body.appendChild(f)}console.log("match",d);0==--c&&b()})})};
